...
THIS LOOKS GOOD, BUT YOU WERE SUPPOSSED TO MAKE A NEW COLUMN WITH JUST THE FOREST NAMES. HERE'S A SLICK WAY TO DO IT USING THE WORD() FUNCTION FROM STRINGR PACKAGE

```{r}
library(tidyverse)
soil$Forest <- word(soil$Field.Name, 1)
```
