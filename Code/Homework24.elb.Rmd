...
MAYBE PUT SOME TEXT HERE ABOUT WHY IT IS A CHI-SQUARE TEST AND WHY YOU HAVE TO USE XTABS
...
ggplot(ozone, aes(x = Ozone)) +
  ...
  theme_bw()
```
WHAT DO YOU SEE IN THE PLOT AND HOW MIGHT YOU GUESSTIMATE THE MEANS FOR THE TWO GROUPS?
## Grouping the data
...
## Run a T-Test
WHY IS A T-TEST APPROPRIATE? MAKE SOME NOTES.
